...
namespace Mixpanel.Tests.MixpanelClient.People
{
    ...
    public class MixpanelClientPeopleSetOnceTests : MixpanelClientPeopleTestsBase
    {
        ...
        {
            Client.PeopleSetOnce(GetProperties(includeDistinctId: true));
        ...
        {
            Client.PeopleSetOnce(GetProperties(includeDistinctId: false));
        ...
        {
            Client.PeopleSetOnce(DistinctId, GetProperties());
            AssertSentData(DistinctId);
        }
