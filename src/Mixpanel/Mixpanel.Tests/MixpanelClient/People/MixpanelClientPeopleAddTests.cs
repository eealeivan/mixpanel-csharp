...
namespace Mixpanel.Tests.Unit.MixpanelClient.People
{
    ...
    public class MixpanelClientPeopleAddTests : MixpanelClientPeopleTestsBase
    {
        ...
        [Test]
        public void PeopleAddAsync_CancellationRequested_RequestCancelled()
        {
            // Arrange
            ...
            var task = Task.Factory.StartNew(
                async () => await client.PeopleAddAsync(new { }, cancellationTokenSource.Token));
        ...
        [Test]
        public void PeopleAddAsyncWithDistinctId_CancellationRequested_RequestCancelled()
        {
            // Arrange
            var (token, distinctId, httpMockMixpanelConfig) = GenerateInputs();
            var cancellationTokenSource = new CancellationTokenSource();
            ...
            // Act
            var task = Task.Factory.StartNew(
                async () => await client.PeopleAddAsync(distinctId, new { }, cancellationTokenSource.Token));
            cancellationTokenSource.Cancel();
            task.Wait();
